 ...
 * @author bernard
 */
public class BI_ExitStaffLoader  implements IBusinessIntelligenceLoader{
    ...
    private IHrGenericDao BI_ExitStaffDao;

    public void setBI_ExitStaffDao(IHrGenericDao BI_ExitStaffDao) {
        this.BI_ExitStaffDao = BI_ExitStaffDao;
    }
    ...
    public void populate() {
       Calendar now = Calendar.getInstance();
        ...
        Query query = emFactory.getEntityManager().
                createQuery("delete from BI_ExitStaff b where b.year=:year and b.month=:month");
        ...
        for (Object[] object : results) {
            ...
            BI_ExitStaff sd = new BI_ExitStaff();
            sd.setBranch(branch);
