 ...
 * @author BERNARD
 */
public class EmployeeXMembershipController extends ParentController {

    private  IHrGenericDao employeeDao;
    private String activeTab = "showAll";
    private String myParam;

    public EmployeeXMembershipController() {
     
        super(EmployeeXMembership.class);
    ...
    public void doNew() {
        ...
        this.setCurrentElement(new EmployeeXMembership());
    ...
    public void doSave() {
        ...
        EmployeeXMembership em = (EmployeeXMembership)this.getCurrentElement();
        em.setEmployee(emp);
