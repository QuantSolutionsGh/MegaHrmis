 ...
 * @author BERNARD
 */
public class EmployeeXRelationshipController extends ParentController {
    ...
    public EmployeeXRelationshipController() {
        super(EmployeeXRelationship.class);
    }
    ...
    public void doNew() {
        ...
        this.setCurrentElement(new EmployeeXRelationship());
    ...
    public void doSave() {
        ...
        EmployeeXRelationship em = (EmployeeXRelationship) this.getCurrentElement();
        em.setEmployee(emp);
    ...
    public Collection getObjList() {
        try {
            ...
            return emp.getRelationshipCollection();
