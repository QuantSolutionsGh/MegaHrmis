 ...
 * @author BERNARD
 */
public class EmployeeHistoryController extends ParentController {
    ...
    public  Collection getObjList() {
        ...
        try {
           ...
           // emp.getMembershipCollection().size();
            ...
            return emp.getEmpHistoryCollection();
    ...
    public void doNew() {
        ...
        this.setCurrentElement(new EmployeeHistory());
    ...
    public void doSave() {
        ...
        EmployeeHistory em = (EmployeeHistory)this.getCurrentElement();
        em.setEmployee(emp);
